...
interface VirtualTourPageClientProps {
  tourStops: TourStop[];
}

export function VirtualTourPageClient({ tourStops }: VirtualTourPageClientProps) {
  return (
    <>
      <Hero
              ...
              {tourStops.map((stop, index) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <button className="inline-flex items-center gap-2 text-navy font-medium hover:text-lime-deep transition-colors group w-full">
                      Explore 360° View
