...
export default function ContactPage() {
  ...
  const contactMethods = [
    { icon: MapPin, label: 'Visit Us', value: universityInfo.address, href: '/visit/directions', linkText: 'Get Directions' },
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {contactMethods.map((method, index) => (
                ...
                >
                  <div className="w-14 h-14 bg-lime/10 text-lime flex items-center justify-center mx-auto mb-4 rounded-none group-hover:bg-lime group-hover:text-navy transition-colors">
                  ...
                  <a
                    href={method.href}
                    className="inline-flex items-center gap-2 text-navy font-medium hover:text-lime transition-colors group"
                  >
                    {method.linkText}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              >
                ...
                <p className="text-white/50 text-sm mt-4 text-center">
                  By submitting this form, you agree to our <a href="/privacy" className="underline hover:text-lime">Privacy Policy</a>.
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-white border border-light-grey">
                    <div className="w-12 h-12 bg-lime/10 text-lime flex items-center justify-center rounded-none flex-shrink-0">
                    ...
                    <a href={universityInfo.social.facebook} target="_blank" rel="noopener" className="ml-auto inline-flex items-center gap-2 text-navy font-medium hover:text-lime transition-colors group">
                      Follow
                      <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-white border border-light-grey">
                    ...
                    <a href={universityInfo.social.twitter} target="_blank" rel="noopener" className="ml-auto inline-flex items-center gap-2 text-navy font-medium hover:text-lime transition-colors group">
                      Follow
                      <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-white border border-light-grey">
                    ...
                    <a href={universityInfo.social.linkedin} target="_blank" rel="noopener" className="ml-auto inline-flex items-center gap-2 text-navy font-medium hover:text-lime transition-colors group">
                      Connect
                      <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-white border border-light-grey">
                    ...
                    <a href={universityInfo.social.instagram} target="_blank" rel="noopener" className="ml-auto inline-flex items-center gap-2 text-navy font-medium hover:text-lime transition-colors group">
                      Follow
                      <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                    </a>
                  </div>
