                    ...
                    {activeFilters.length > 0 && (
                      <div className="flex flex-wrap gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-1 text-navy/60 hover:text-lime-deep text-sm font-medium"
                        >
                          Clear all
                        </button>
                      </div>
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="space-y-2 mb-4 text-sm text-medium-grey">
                      <div className="flex items-center gap-2">
                        <span className="w-5 h-5 text-lime-deep flex-shrink-0" aria-hidden="true">⏱</span>
              ...
              {studyCategories.map((category, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <span className="text-lime-deep font-display font-bold text-3xl">0{index + 1}</span>
