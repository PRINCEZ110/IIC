...
export function ResearchersPageClient() {
    ...
    <>
      ...
      <main id="main-content" className="flex-1 pt-20 md:pt-24 lg:pt-32">
            ...
            >
              ...
              />
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    <h3 className="font-display font-bold text-navy text-lg mb-1 group-hover:text-lime-deep transition-colors">
        ...
        <CTASection
          ...
          secondaryCta={{ text: 'Contact Graduate Research', href: '/contact' }}
          variant="navy"
        />
      </main>
      <Footer />
