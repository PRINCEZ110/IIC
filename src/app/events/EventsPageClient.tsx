...
import { Search,  X, Calendar, MapPin, Clock,  Tag } from 'lucide-react';
    ...
    <>
      ...
      <main id="main-content" className="flex-1 pt-20 md:pt-24 lg:pt-32">
                ...
                <div className="relative">
                  ...
                  {searchQuery && (
                    <button
                      ...
                      className="absolute right-5 top-1/2 -translate-y-1/2 text-navy/40 hover:text-lime-deep transition-colors p-1"
                      ...
                      <Link href={`/events/${event.slug}`} className="block p-5 md:p-6">
                        <div className="flex flex-col md:flex-row md:items-center gap-5">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-wrap items-center gap-3 text-sm text-medium-grey mb-2">
                              ...
                              {event.registrationRequired && (
                                <span className="px-2 py-1 bg-lime/10 text-lime-deep font-medium text-xs">Registration Required</span>
                              )}
                            </div>
                            <h3 className="font-display font-semibold text-navy text-lg md:text-xl mb-1 group-hover:text-lime-deep transition-colors">
                              {event.title}
                            </h3>
                          ...
                          <div className="flex-shrink-0 ml-auto md:ml-0">
                            <span className="inline-flex items-center gap-1 text-navy font-medium hover:text-lime-deep transition-colors group">
                              View Details
            ...
            {pastEvents.length > 0 && (
              ...
              />
                      ...
                      <div className="p-4">
                        ...
                        <h3 className="font-display font-bold text-navy text-base mb-1 group-hover:text-lime-deep transition-colors">{event.title}</h3>
        ...
        <CTASection
          ...
          primaryCta={{ text: 'Subscribe to Events', href: '/contact?type=events' }}
          secondaryCta={{ text: 'Host an Event', href: '/events' }}
          variant="lime"
        />
      </main>
      <Footer />
