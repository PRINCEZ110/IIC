    ...
    <>
      ...
      <main id="main-content" className="flex-1 pt-20 md:pt-24 lg:pt-32">
          ...
          <div className="container">
            ...
            {news.find(n => n.featured) && (
              ...
              />
                  ...
                  <h2 className="font-display font-extrabold text-navy text-3xl md:text-4xl mb-4 hover:text-lime-deep transition-colors line-clamp-2">
                    {news.find(n => n.featured)!.title}
                  </h2>
                  <p className="text-dark-grey text-lg leading-relaxed mb-4">{news.find(n => n.featured)!.excerpt}</p>
                  <div className="inline-flex items-center gap-2 text-navy font-semibold hover:text-lime-deep transition-colors group">
                    Read Article
            ...
            >
              ...
              />
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <h3 className="font-display font-bold text-navy text-xl mb-2 group-hover:text-lime-deep transition-colors line-clamp-2">
        ...
        <CTASection
          ...
          primaryCta={{ text: 'Subscribe to Newsletter', href: '/contact' }}
          secondaryCta={{ text: 'Press Office', href: '/news' }}
          variant="navy"
        />
      </main>
      <Footer />
