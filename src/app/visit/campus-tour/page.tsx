            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                >
                  ...
                  <a href={item.href} className="inline-flex items-center gap-2 text-navy font-medium hover:text-lime transition-colors mt-auto group">
                    {item.cta}
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <form className="bg-white border border-light-grey p-6 md:p-8 space-y-6" noValidate>
                ...
                <div>
                  ...
                  <input type="date" id="date" name="date" required min={new Date().toISOString().split('T')[0]} className="w-full bg-white border-2 border-light-grey focus:border-lime focus:ring-2 focus:ring-lime/20 text-navy py-3 px-4 transition-all duration-200" />
                </div>

                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-navy mb-1">Additional Information</label>
                  <textarea id="message" name="message" rows={4} className="w-full bg-white border-2 border-light-grey focus:border-lime focus:ring-2 focus:ring-lime/20 text-navy py-3 px-4 transition-all duration-200 resize-y" placeholder="Any specific areas you'd like to see? Questions for faculty? Accessibility requirements?" />
                </div>
